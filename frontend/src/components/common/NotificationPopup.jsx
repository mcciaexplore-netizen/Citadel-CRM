...
export default function NotificationPopup() {
    ...
    switch (type) {
        case 'FollowUp': borderColor = 'border-l-[#1565C0]'; iconColor = 'text-[#1565C0]'; break;
        case 'Payment': borderColor = 'border-l-red-500'; iconColor = 'text-red-500'; break;
        case 'Dispatch': borderColor = 'border-l-orange-500'; iconColor = 'text-orange-500'; break;
        case 'CrossSell': borderColor = 'border-l-[#2E7D32]'; iconColor = 'text-[#2E7D32]'; break;
        case 'GoogleReview': borderColor = 'border-l-purple-500'; iconColor = 'text-purple-500'; break;
        case 'Reference': borderColor = 'border-l-teal-500'; iconColor = 'text-teal-500'; break;
        default: borderColor = 'border-l-[#1565C0]'; iconColor = 'text-[#1565C0]'; break;
    }
