                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/60 backdrop-blur-sm p-4 animate-in fade-in">
                    <form onSubmit={handleResetSubmit} className="bg-white rounded-xl shadow-2xl w-full max-w-sm overflow-hidden animate-in zoom-in-95">
                        <div className="px-6 py-4 border-b border-orange-100 flex justify-between items-center bg-orange-50">
                            <h2 className="text-base font-bold text-orange-900 flex items-center gap-1.5"><KeyRound size={16} /> Override Vault Key</h2>
                        </div>
                        <div className="p-6">
                            ...
                            <div>
                                ...
                                <input required type="text" value={form.NewPassword} onChange={e => setForm({ ...form, NewPassword: e.target.value })} minLength={8} className="w-full px-3 py-2 border rounded bg-gray-50 font-mono tracking-widest text-lg text-center focus:border-orange-500 focus:ring-orange-500 text-orange-600" />
                            </div>
                        </div>
                        <div className="px-6 py-4 bg-gray-50 border-t flex justify-end gap-2">
                            ...
                            <button type="submit" disabled={submitting} className="px-5 py-2 bg-orange-600 text-white rounded font-bold text-sm hover:bg-orange-700 shadow-sm">Execute Reset</button>
                        </div>
                    </form>
                </div>
            )}
